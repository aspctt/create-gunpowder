...
Minecraft 1.21.1, NeoForge 21.1.217 or newer, and Create 6.0.9 or newer in the 6.0 line.

### License

Create: Gunpowder is All Rights Reserved. The full terms are in [LICENSE](LICENSE), and the short version is:

- Download it and play with it freely.
- Datapacks, resource packs, KubeJS or CraftTweaker scripts, and configs that rebalance, extend, or switch off the recipes are yours to make, distribute, and sell. That grant is irrevocable, and no attribution is required.
...
- The source code and the mod’s own assets stay reserved.

Versions 1.0.0 and 1.0.1 were released under GPL-3.0-or-later, and stay available under that licence to anyone who already has them. The terms above cover every release that follows.
